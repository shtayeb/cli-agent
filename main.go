...
func main() {
	...
	tools := []ToolDefinition{ReadFileDefination, ListFilesDefination, EditFileDefinition}
...
var ReadFileDefination = ToolDefinition{
	Name:        "read_file",
...
var ListFilesDefination = ToolDefinition{
	Name:        "list_files",
